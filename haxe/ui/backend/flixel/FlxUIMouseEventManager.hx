 ...
 * @author MSGhero
 */
class FlxUIMouseEventManager extends FlxBasic {
	
	static var _registeredObjects:Array<ObjectMouseData<Component>> = [];
	static var _mouseOverObjects:Array<ObjectMouseData<Component>> = [];
	static var _mouseDownObjects:Array<ObjectMouseData<Component>> = [];
	static var _mouseClickedObjects:Array<ObjectMouseData<Component>> = [];
	...
	{
		if (FlxG.plugins.get(FlxUIMouseEventManager) == null)
			FlxG.plugins.add(new FlxUIMouseEventManager());
	}
	 ...
	 */
	public static function add<T:Component>(Object:T, ?OnMouseDown:T->Void, ?OnMouseUp:T->Void, ?OnMouseOver:T->Void,
		?OnMouseOut:T->Void, MouseChildren = false, MouseEnabled = true, PixelPerfect = false, ?MouseButtons:Array<FlxMouseButtonID>):T
	{
	 ...
	 */
	public static function remove<T:Component>(Object:T):T
	{
	 ...
	 *                          Must have Object as argument - e.g. `onMouseDown(object:FlxObject)`.
	 */
	public static function setMouseDownCallback<T:Component>(Object:T, OnMouseDown:T->Void):Void
	{
	 ...
	 *                      Must have Object as argument - e.g. `onMouseDown(object:FlxObject)`.
	 */
	public static function setMouseUpCallback<T:Component>(Object:T, OnMouseUp:T->Void):Void
	{
		var reg = getRegister(Object);
	 ...
	 * @since 4.4.0
	 */
	public static function setMouseClickCallback<T:Component>(Object:T, OnMouseClick:T->Void):Void
	{
		var reg = getRegister(Object);
	 ...
	 * @since 4.4.0
	 */
	public static function setMouseDoubleClickCallback<T:Component>(Object:T, OnMouseDoubleClick:T->Void):Void
	{
		var reg = getRegister(Object);
	 ...
	 *                        Must have Object as argument - e.g. `onMouseDown(object:FlxObject)`.
	 */
	public static function setMouseOverCallback<T:Component>(Object:T, OnMouseOver:T->Void):Void
	{
		var reg = getRegister(Object);
	 ...
	 *                        Must have Object as argument - e.g. `onMouseDown(object:FlxObject)`.
	 */
	public static function setMouseOutCallback<T:Component>(Object:T, OnMouseOut:T->Void):Void
	{
		var reg = getRegister(Object);
	 ...
	 * @since 4.4.0
	 */
	public static function setMouseMoveCallback<T:Component>(Object:T, OnMouseMove:T->Void):Void
	{
		var reg = getRegister(Object);
	 ...
	 * @since 4.4.0
	 */
	public static function setMouseWheelCallback<T:Component>(Object:T, OnMouseWheel:T->Void):Void
	{
		var reg = getRegister(Object);
	 ...
	 */
	public static function setObjectMouseEnabled<T:Component>(Object:T, MouseEnabled:Bool):Void
	{
		var reg = getRegister(Object);
	 ...
	 */
	public static function isObjectMouseEnabled<T:Component>(Object:T):Bool
	{
		var reg = getRegister(Object);
	 ...
	 */
	public static function setObjectMouseChildren<T:Component>(Object:T, MouseChildren:Bool):Void
	{
		var reg = getRegister(Object);
	 ...
	 */
	public static function isObjectMouseChildren<T:Component>(Object:T):Bool
	{
		var reg = getRegister(Object);
	 ...
	 * @param   MouseButtons    The mouse buttons that can trigger callbacks. Left only by default.
	 */
	public static function setObjectMouseButtons<T:Component>(object:T, mouseButtons:Array<FlxMouseButtonID>):Void
	{
		var reg = getRegister(object);
	...
	function traverseFlxGroup(component:Component, OrderedObjects:Array<ObjectMouseData<Component>>):Void
	{
		for (comp in component.childComponents)
		{
			if (comp.alive && comp.exists && !comp.hidden) {
				
				var reg = getRegister(comp);
				
				if (reg != null && reg.mouseEnabled) {
					
					if (reg.mouseChildren) {
						traverseFlxGroup(comp, OrderedObjects);
					}
	...
	static function getRegister<T:Component>(Object:T, ?Register:Array<ObjectMouseData<Component>>):ObjectMouseData<T>
	{
		if (Register == null)
		{
	...
	public function new()
	{
		...
		_registeredObjects = new Array<ObjectMouseData<Component>>();
		_mouseOverObjects = new Array<ObjectMouseData<Component>>();
		_mouseDownObjects = new Array<ObjectMouseData<Component>>();
		_mouseClickedObjects = new Array<ObjectMouseData<Component>>();
	...
	override public function update(elapsed:Float):Void
	{
		...
		var currentOverObjects = new Array<ObjectMouseData<Component>>();
		
		// start from top level container's kids
		// fill a stack with hittested children recursively, based on mouseEnabled and mouseChildren, alive, exists, and visible I guess
		// the stack is currentOverObjects, and the rest happens normally
		
		var container = Toolkit.screen.options.container;
		
		if (container == null) return; // is this the correct thing to do?
		
		for (child in container.members) {
			if (Std.is(child, Component)) traverseFlxGroup(cast child, currentOverObjects);
		}
	...
	function checkOverlap<T:Component>(Register:ObjectMouseData<T>):Bool
	{
	...
	inline function checkOverlapWithPoint<T:Component>(Register:ObjectMouseData<T>, Point:FlxPoint, Camera:FlxCamera):Bool
	{
		if (Register.pixelPerfect && (Register.object != null))
		{
			return checkPixelPerfectOverlap(Point, Register.object, Camera);
		}
		else 
		{
...
private class ObjectMouseData<T:Component> implements IFlxDestroyable
{
